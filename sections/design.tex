...
\subsection{Problem decomposition\label{subsection:design:problem-decomposition}}
...
\subsection{Structure of the solution\label{subsection:design:structure-of-the-solution}}

\subsubsection{The main project\label{subsubsection:design:the-main-project}}
...
\subsubsection{The \texttt{gui} subpackages\label{subsubsection:design:the-gui-subpackages}}
...
\subsection{Algorithm design\label{subsection:design:algorithm-design}}

% TODO: Write pseudocode and/or create flowcharts for this shit

This section will be completed later.

\subsection{Usability features\label{subsection:design:usability-features}}
...
\subsection{Variables and validation\label{subsection:design:variables-and-validation}}
...
\subsection{Iterative test data\label{subsection:design:iterative-test-data}}
...
\subsection{Post-development test data\label{subsection:design:post-development-test-data}}
