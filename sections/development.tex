...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{development/cf05e09e5ebb6ea7a96db8660d0d8de6b946490a/gui.png}
	\caption{An example of the new oblique lines system.}
	\label{fig:development:cf05e09e5ebb6ea7a96db8660d0d8de6b946490a:gui.png}
\end{figure}

Just to prove that this new system works, figure~\ref{fig:development:cf05e09e5ebb6ea7a96db8660d0d8de6b946490a:gui.png} shows \texttt{2rot(200)} being rendered.
