...
\subfile{development/processed_preparing_for_v0.2.1.tex}

\newpage

\subsection{Making \texttt{v0.2.2}\label{development:making-v0.2.2}}
\subfile{development/processed_making_v0.2.2.tex}

\newpage

\subsection{Teacher suggestions\label{development:teacher-suggestions}}
\subfile{development/processed_teacher_suggestions.tex}
