...
\subsubsection{\texttt{MatrixWrapper} class\label{subsubsection:development:matrices-backend:MatrixWrapper-class}}
...
\subsubsection{Rudimentary parsing and evaluating\label{subsubsection:development:matrices-backend:rudimentary-parsing-and-evaluating}}
...
\subsubsection{Simple matrix expression validation\label{subsubsection:development:matrices-backend:simple-matrix-expression-validation}}
...
\subsubsection{Parsing matrix expressions\label{subsubsection:development:matrices-backend:parsing-matrix-expressions}}
...
It works similarly to the old \texttt{MatrixWrapper.parse\_expression()} method in \S\ref{subsubsection:development:matrices-backend:rudimentary-parsing-and-evaluating} but with a powerful list comprehension at the end. It splits the expression up into groups and then uses some RegEx magic to find all the matrices in these groups as a tuple.
