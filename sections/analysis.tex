...
\begin{wrapfigure}{R}{0.5\linewidth}
	\vspace{-1em}
	\centering
	\includegraphics[width=\linewidth]{analysis/mit-mathlet-matrix-vector}
	\caption{The MIT \enquote{Matrix Vector} Mathlet}
	\label{fig:analysis:mit-mathlet-matrix-vector}
	\vspace{-1em}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.5\linewidth}
	\vspace{-1em}
	\centering
	\includegraphics[width=\linewidth]{analysis/shad-io-matvis}
	\caption{\enquote{Linear Transformation Visualizer} halfway through an animation}
	\label{fig:analysis:shad-io-matvis}
	\vspace{-1em}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.5\linewidth}
	\vspace{-1em}
	\centering
	\includegraphics[width=\linewidth]{analysis/desmos-2d-linear-transformation}
	\caption{The Desmos app halfway through an animation, rendering $f(x) = \frac{\sin^2 x}{x}$ in orange}
	\label{fig:analysis:desmos-2d-linear-transformation}
	\vspace{-1em}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.5\linewidth}
	\vspace{-1em}
	\centering
	\includegraphics[width=\linewidth]{analysis/geogebra-applet}
	\caption{The GeoGebra applet rendering its default matrix}
	\label{fig:analysis:geogebra-applet}
	%\vspace{-1em}
\end{wrapfigure}
