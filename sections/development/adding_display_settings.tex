...
As far as I know, a dialog in Qt can't really return a value when it's closed, so the dialog keeps a public instance attribute for the \texttt{DisplaySettings} class itself, and then the main window can copy that instance attribute when the dialog is closed.

%: e4d3aa7eab70daecd16814972a281745110d64a5
...
%: e4d3aa7eab70daecd16814972a281745110d64a5
%: src/lintrans/gui/main_window.py:425-434
