...
I also wrapped the main logic of \texttt{animate_between_matrices()} in an \pyinline{if} block to check if the user wants the determinant to be smoothed.
