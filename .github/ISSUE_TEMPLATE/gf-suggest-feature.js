...
function onFormSubmit(e) {
  ...
  try {
    ...
    var body = "<p>Hi,</p><p>Thank you for suggesting your new feature, you can follow it on <a href='" + issue.html_url + "'>this page</a>.</p>";

    GmailApp.sendEmail(Session.getEffectiveUser().getEmail(), 'Feature suggestion posted on GitHub', '', {
      htmlBody: body,
    });

  } catch(e) {
    GmailApp.sendEmail(Session.getEffectiveUser().getEmail(), 'Error with feature suggestion submission', '', {
...
function submitIssue(data) {
  ...
  if (service.hasAccess()) {
    ...
    var apiRequestBody = {
      "title": "[Suggestion] " + data["Feature suggestion title"],
